...
include('svlogdat/daten.inc.php');
include ("svlogdat/mail_class.php");
//////////////////////////////////// FREE VERSION //////////////////////////////////////////////////
function error($text)
{
...

{
...

	{
		...
		echo  "<img src='images/regat/reg_rosu.png'";
...

	{
		...
		echo "<img src='images/regat/reg_galben.png'";
...

	{
		...
		echo "<img src='images/regat/reg_albastru.png'";
...

		{
...

			{
				...
				{		$rec = md5(rand(99999,9999999));
					...
					http://metin2rapsodia.ro/index.php?page=recuperare-pw&cont=".$username."&cod=".$rec."
...

{
...

	{
		...
		Pentru o siguranta mai mare, &Icirc;nainte de stergerea caracterului, este nevoie de introducerea unui cod special.". "\r\n" ."
...

{
...

	{
		...
		http://metin2rapsodia.ro/index.php?page=stergere-cont&cont=".$log."&cod=".$cod."". "\r\n" ."
...

{
...

	{
		...
		function romana($var){
			...
			$new_var=str_replace("�","a",$var);

			$new_var=str_replace("�","a",$new_var);

			$new_var=str_replace("�","I",$new_var);
			...
			$new_var=str_replace("�","t",$new_var);

			$new_var=str_replace("�","s",$new_var);
