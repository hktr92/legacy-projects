<h2>Administrare - Log Login</h2>
<p><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pe aceast&#259; pagin&#259; pute&#355;i urm&#259;ri ultimele 10 activit&#259;&#355;i de autentificare.<br><br></p>
<table> 
<tr>
  <th class="topLine">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ID</th>
  <th class="topLine">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CH</th>
  <th class="topLine">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Job</th>
  <th class="topLine">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Level</th>
  <th class="topLine">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Timp de joc</th>
...
<?PHP
 if(isset($_SESSION['user_admin']) && checkInt($_SESSION['user_admin']) && $_SESSION['user_admin']>=0) {
	...
	$ergebnis = mysql_query("SELECT account_id,channel,job,level,playtime,type,time from log.loginlog ORDER BY time DESC LIMIT ".$test[1].",".$serverSettings['page_entries']);
	...
	if($i<=50) {
      ...
      echo'<a href="index.php?a=loginlog&p='.$i.'">';
	...
	while($row = mysql_fetch_object($ergebnis))
{
    ...
    echo '<td class="thell">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$row->channel.'</td>';
    echo '<td class="thell">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$row->job.'</td>';
...
<input class="txt" name="ID"> <input type="submit" name="submit" value="&#350;terge" class="btn-bg"/>
</center><br/>
</form>
