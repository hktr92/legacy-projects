...
<h2>Administrare - editare item_attr </h2>
<?PHP
...
$sqlQry = mysql_query($sqlCmd,$sqlServ); 
?>
<p>In aceast&#259; pagin&#259; pute&#355;i edita bonusurile din tabela item_attr. Acesta con&#355;ine datele bonusurilor. <br/> <b> Datele sunt foarte sensibile, modifica&#355;ile cu mare aten&#355;ie!</b></p>
    ...
    <?PHP
      ...
      while($getAttr=mysql_fetch_object($sqlQry)) {
        if(!empty($getAttr->apply)) {
          ...
          echo'<td class="'.$zF.'"><input size="1" maxlength="10" type="text" name="prob[]" value="'.$getAttr->prob.'"/></td>';
          echo'<td class="'.$zF.'"><input size="1" maxlength="10" type="text" name="lv1[]" value="'.$getAttr->lv1.'"/></td>';
          echo'<td class="'.$zF.'"><input size="1" maxlength="10" type="text" name="lv2[]" value="'.$getAttr->lv2.'"/></td>';
          echo'<td class="'.$zF.'"><input size="1" maxlength="10" type="text" name="lv3[]" value="'.$getAttr->lv3.'"/></td>';
          echo'<td class="'.$zF.'"><input size="1" maxlength="10" type="text" name="lv4[]" value="'.$getAttr->lv4.'"/></td>';
          echo'<td class="'.$zF.'"><input size="1" maxlength="10" type="text" name="lv5[]" value="'.$getAttr->lv5.'"/></td>';
          echo'<td class="'.$zF.'"><input size="1" maxlength="10" type="text" name="weapon[]" value="'.$getAttr->weapon.'"/></td>';
          echo'<td class="'.$zF.'"><input size="1" maxlength="10" type="text" name="body[]" value="'.$getAttr->body.'"/></td>';
          echo'<td class="'.$zF.'"><input size="1" maxlength="10" type="text" name="wrist[]" value="'.$getAttr->wrist.'"/></td>';
          echo'<td class="'.$zF.'"><input size="1" maxlength="10" type="text" name="foots[]" value="'.$getAttr->foots.'"/></td>';
          echo'<td class="'.$zF.'"><input size="1" maxlength="10" type="text" name="neck[]" value="'.$getAttr->neck.'"/></td>';
          echo'<td class="'.$zF.'"><input size="1" maxlength="10" type="text" name="head[]" value="'.$getAttr->head.'"/></td>';
          echo'<td class="'.$zF.'"><input size="1" maxlength="10" type="text" name="shield[]" value="'.$getAttr->shield.'"/></td>';
          echo'<td class="'.$zF.'"><input size="1" maxlength="10" type="text" name="ear[]" value="'.$getAttr->ear.'"/></td>';
          echo'</tr>';
          $x++;
        }
      }
