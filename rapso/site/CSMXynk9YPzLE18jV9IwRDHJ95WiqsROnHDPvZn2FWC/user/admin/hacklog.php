<h2>Administrare - Log Hack</h2>
<p><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pe aceast&#259; pagin&#259; pute&#355;i urm&#259;ri ultimele 10 activit&#259;&#355;i de Hack.<br><br></p>
<table> 
<tr>
  <th class="topLine">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Nume</th>
  <th class="topLine">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Login</th>
  <th class="topLine">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;IP</th>
  <th class="topLine">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Server</th>
  <th class="topLine">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tip hack</th>
...
<?PHP
 if(isset($_SESSION['user_admin']) && checkInt($_SESSION['user_admin']) && $_SESSION['user_admin']>=0) {
	...
	$ergebnis = mysql_query("SELECT name,login,ip,server,why,time from log.hack_log ORDER BY time DESC LIMIT ".$test[1].",".$serverSettings['page_entries']);
	...
	if($i<=50) {
      ...
      echo'<a href="index.php?a=hacklog&p='.$i.'">';
	...
	while($row = mysql_fetch_object($ergebnis))
{
    ...
    echo '<td class="thell">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$row->login.'</td>';
    echo '<td class="thell">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$row->ip.'</td>';
	echo '<td class="thell">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$row->server.'</td>';
    echo '<td class="thell">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$row->why.'</td>';
