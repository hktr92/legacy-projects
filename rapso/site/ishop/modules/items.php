...

	{
...

		{
			...
			if($_GET['cat'] != null)
				...
				$data .= '<span  class="'. $class .'"><a href="?page='.$_GET['page'].'&cat='.$_GET['cat'].'&id='.$i.'" onclick="load()" class="pagination">'. $i .'</a></span> ';
...

{
	...
	$result = mysql_query("SELECT * FROM ".$web_db.".dev_is_items WHERE cat_id='".$_GET['cat']."' ORDER BY id DESC");
	...
	$result = mysql_query("SELECT * FROM ".$web_db.".dev_is_items"); 
...

{
	...
	$result2 = mysql_query("select * from ".$web_db.".dev_is_items WHERE cat_id='".$_GET['cat']."' ORDER BY id DESC limit ".($page_rows * ($pagenum - 1)).", ".$page_rows.""); 
...
$result2 = mysql_query("select * from ".$web_db.".dev_is_items limit ".($page_rows * ($pagenum - 1)).", ".$page_rows.""); 
...
<table width="143" border="2" cellspacing="0" cellpadding="0">
...
<table width="100%" border="0" align="right" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td align="center"><table width="35%" border="0" cellspacing="0" cellpadding="0">
...

{
	...
	mysql_query("Delete from ".$web_db.".dev_is_items where id='$id'");	
...
?>
 ...
 <a href="index.php?page=items&buy=<?=$getItems->id;?>" class="link_cat" onclick="buyitem()">Cumpara </a>
...
echo '</tr></table>';
	...
	echo "<br /><center><span class='pagination'><b>&lt; Pagina : ";
