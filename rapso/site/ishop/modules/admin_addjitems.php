 ...
 if(isset($_SESSION['is_user']) && isset($_SESSION['is_pass']) && $_SESSION['is_admin'])
...
&& in_array($extension, $allowedExts))
  ...
  if ($_FILES["file"]["error"] > 0)
    ...
    if (file_exists("images/item/" . $_FILES["file"]["name"]))
	 ...
	 echo '<meta http-equiv="refresh" content="1;url=index.php?page=admin_addjitems">';
