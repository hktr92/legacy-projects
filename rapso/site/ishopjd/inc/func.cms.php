...
require("inc/config.inc.php");
	...
	$q = mysql_query("Select img_status FROM ".$web_db.".dev_jd_items where vnum='$item'");

	$it = mysql_fetch_object($q);

	$itemalin = mysql_fetch_row(mysql_query("SELECT imagine from  ".$web_db.".dev_jd_items where vnum='$item'"));
...
require("inc/config.inc.php");
	...
	if ($it->img_status > "0") {
		...
		echo "<img src='images/jitem/$itemalin[0].png'>";
	...
	$immagine_item = "images/jitem/0000".$item.".png";
	...
	$immagine_item = "images/jitem/000".substr($item, 0, 1)."0.png";
	...
	$immagine_item = "images/jitem/00".substr($item, 0, 2)."0.png";
	...
	$immagine_item = "images/jitem/0".substr($item, 0, 3)."0.png";
	...
	$immagine_item = "images/jitem/".substr($item, 0, 4)."0.png";
	...
	$immagine_item = "images/jitem/".substr($item, 0, 5)."0.png";
	...
	$immagine_item = "images/jitem/error.png";
