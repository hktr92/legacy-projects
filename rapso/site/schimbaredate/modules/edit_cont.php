...
<li>Jetoane dragon  :<span id="yourEmail"> <?=$chkk->jcoins;?></span> [<a href="index.php?page=add_jmonezi&cont=<?=$ui?>">+</a>]</li>
...
{ debanare_cont();?> <tr class="top">
  ...
  <tr  class="top">
    <td><a href="index.php?page=add_jmonezi&cont=<?=$ui?>" class="btn">&raquo; Jetoane</a></td>
    <td><em class="edit_cont">Adauga jetoane acestui cont</em></td>
  </tr>
  <tr  class="top">
