<center><img src="http://metin2rapsodia.ro/images/slide.png" title="Rapsodia" /></center>
<p></p>
<?php $nm = mysql_query("Select * from web.dev_news order by id desc");
  ...
  <tr>
    <td><?=unentities($nw->continut)?><br />  <span class="mini_top"><i>Postat la <?=$nw->data?></i></span></td>
  </tr>
   <tr>
