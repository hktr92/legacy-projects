...
$result2 = mysql_query("Select * from player.player WHERE name NOT LIKE '[%]%' ORDER BY playtime DESC limit ".($page_rows * ($pagenum - 1)).", ".$page_rows.""); 
...
<tr>
                        ...
                        <tr>
                        <td width="232" align="left" class="iR_stats"><?=$nr?>.<a href="index.php?page=jucator&id=<?=$acs->id?>"><?=$acs->name?></a></td>
                        <td width="148" class="collect" align="center">Level
                            <?=$acs->level?></td>
                        <td width="170" align="center" class="iR_stats">Exp :
                            <?=$acs->exp?></td>
                        <td width="312" align="center" class="iR_stats_level">
                        <?=nume_regat($empire)?>
                        </td>
                        </tr>
                        <tr>
                        ...
                        <td align="center" class="iR_status">Yang :
                          <?=$acs->gold?></td>
                        <td align="center" class="collect"><?=$acs->playtime?> minute online</td>
                        </tr>
                        <tr>
